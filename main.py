...
class DemoApp(MDApp):
    ...
    def hlist(self, selected_cat, selected_r):
    ...
    def hrdialog(self):
        close_button = MDFlatButton(text="Okay", on_release=self.close_dialog)
        self.dialog = MDDialog(title="Manual BPM Check",
                               text="Age   Target BPM   Average BPM \n 20   100 to 170      200 \n 30   95 to 162     "
                                    "   190 \n 35   93 to 157        185 \n 40   90 to 153        180 \n 45   88 to "
                                    "149       175 \n 50   85 to 145       170 \n 55   83 to 140       165 \n 60   80 "
                                    "to 136       160 \n 65   78 to 132        155 \n 70   75 to 128       150 \n If "
    ...
    def info2dialog(self):
        close_button = MDFlatButton(text="Okay", on_release=self.close_dialog)
        self.dialog = MDDialog(title="Instructions",
                               text="Manual Heartbeat check can be used to determine if you have a normal heart rate "
                                    "for your age. \n  "
